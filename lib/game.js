...
class Game {
  ...
  gameOver(){
     ...
     let overText = new createjs.Text("GAME OVER", "70px Visitor", "#FF0000");
     overText.x = 20;
     overText.y = 100;
     overText.textBaseline = "alphabetic";
     this.stage.addChild(overText);
     let resetText = new createjs.Text("Press space to play again.", "40px Visitor", "#FF0000");
     resetText.x = 10;
     resetText.y = 200;
