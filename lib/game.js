...
class Game {
  ...
  gameOver(){
     ...
     let overText = new createjs.Text("GAME OVER", "80px Helvetica", "#FF0000");
     overText.x = 0;
     overText.y = 100;
     overText.textBaseline = "alphabetic";
     this.stage.addChild(overText);

     let resetText = new createjs.Text("Press space to play again.", "40px Helvetica", "#57CDFF");
     resetText.x = 10;
     resetText.y = 300;
     resetText.textBaseline = "alphabetic";
     this.stage.update();
     setTimeout(this.stage.update(), 1000);
