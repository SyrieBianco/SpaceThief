...
class Game {
  constructor() {
    this.score = 0;
    this.ship = new Ship("http://res.cloudinary.com/syriebianco/image/upload/v1504674457/spaceship24_dutwos.png");
    this.mines = [];
    this.gem = null;
    // bindings
  ...
  generateMine(){
    const newMine = new Mine("http://res.cloudinary.com/syriebianco/image/upload/v1504674457/mine_utbsl4.png")
  ...
  generateExplosion(obj1, obj2){
    ...
    const x = obj2.x - xc;
    const y = obj2.y - yc;
    const explosion = new createjs.Bitmap("http://res.cloudinary.com/syriebianco/image/upload/v1504674456/explosion_gzgdlu.png");
    explosion.x = x;
    explosion.y = y;
    explosion.regX = xc;
    explosion.regY = yc;
